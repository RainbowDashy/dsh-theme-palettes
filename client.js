...
//
// This is a Client-side Cordis plugin. It registers a selectable dark theme
// (id `vscode-red`) on the built-in `theme` service and activates it. The
// service writes every token below as an inline CSS variable on <body>, so
// the whole page surface is re-tinted without touching the DOM structure.
